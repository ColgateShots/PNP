...
ref_bcs += [fn.DirichletBC(V.sub(0), u_GND, mf, 3)]
# define problem
UC    = fn.Function(V)
...
ax.plot(np.linspace(0,600),[S2(100,x,0) for x in np.linspace(0,600)])
ax.plot(np.linspace(0,900),[S3(200,x,0) for x in np.linspace(0,900)])
...
p10, = host.plot(0.0327683*np.linspace(0,500),[S1(0,x,0) for x in np.linspace(0,500)],"-", color="#CC0000", label="Potential @ r = 0 $\lambda_D$")
p11, = host.plot(0.0327683*np.linspace(0,600),[S1(100,x,0) for x in np.linspace(0,600)],"--", color="#CC0000",label="Potential @ r = 3.25 $\lambda_D$")
p12, = host.plot(0.0327683*np.linspace(0,900),[S1(200,x,0) for x in np.linspace(0,900)], "-.",color="#CC0000", label="Potential @ r = 6.5 $\lambda_D$")
p13, = host.plot(0.0327683*np.linspace(0,1000),[S1(224,x,0) for x in np.linspace(0,1000)],".", color="#CC0000", label="Potential @ r = 7.33 $\lambda_D$")

p20, = par1.plot(0.0327683*np.linspace(0,500),[S2(0,x,0)*10000 for x in np.linspace(0,500)],"-", color="#0080FF", label="Concentration @ r = 0 $\lambda_D$")
p21, = par1.plot(0.0327683*np.linspace(0,600),[S2(100,x,0)*10000 for x in np.linspace(0,600)],"--", color="#0080FF",label="Concentration @ r = 3.25 $\lambda_D$")
p22, = par1.plot(0.0327683*np.linspace(0,900),[S2(200,x,0)*10000 for x in np.linspace(0,900)],"-.", color="#0080FF", label="Concentration @ r = 6.5 $\lambda_D$")
p23, = par1.plot(0.0327683*np.linspace(0,1000),[S2(224,x,0)*10000 for x in np.linspace(0,1000)],".", color="#0080FF", label="Concentration @ r = 7.33 $\lambda_D$")
